...
# this file includes metrices for image segmentation problem
...
def dice_score(logits, targets, thresh):
    # using Sigmoid because:
    # Softmax is used (Softmax Classifier) when ‘n’ number of classes are there.
...
if __name__ == "__main__":
    rle = "6908 1 7161 8 7417 8 7672 9 7928 9 8184 9 8440 9 8696 9 8952 9 9209 8 9465 8 9722 7 9978 7 10235 6 10493 4 10752 1"
    mask = run_length_decode(rle, 256, 256, fill_value=255)
    plt.imshow(mask)
    plt.imsave("saved.png", mask)
